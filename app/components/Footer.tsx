      ...
      <div className="flex justify-between px-14 py-8">
          <div className="flex flex-col gap-5">
              ...
              <ul className="flex flex-col gap-4">
                <li className="flex gap-2 items-center"><Image src={emailLogo} alt="email"/>erabanyusegara@gmail.com</li>
                <li className="flex gap-2 items-center"><Image src={teleponLogo} alt="telepon"/>081234567899</li>
                <li className="flex gap-2 items-center"><Image src={lokasiLogo} alt="lokasi"/>Hegarmukti, Cikarang Pusat, Bekasi - Jawa Barat 17530</li>
              </ul>
          </div>
          <div className="flex flex-col gap-5">
